...
busPlatform53116_28 = { 'BUS_PLATFORM' : 53116, 'BUS_LINE' : 28 }
busPlatform53088_P = { 'BUS_PLATFORM' : 53088, 'BUS_LINE' : 'P' }
busPlatform53088_80 = { 'BUS_PLATFORM' : 53088, 'BUS_LINE' : 80 }
busPlatformsNum = [ busPlatform53116_17, busPlatform53116_B, busPlatform53116_28, busPlatform53088_P, busPlatform53088_80 ]
...
class GUI:
    def __init__(self, master, **kwargs):
        ...
        busNoLbl = tk.Label(subHeadersFrame, text=" Bus No.", font=("Helvetica", subHeaderFontSize), bg="black", fg="white")
    ...
    def populateTable(self, departures):
        ...
        for departure in departures:
           ...
           # platformNo = tk.Label(rowFrame, text="{} {}".format(" ", platform), font=("Helvetica", departureFontSize), bg=bgColor)
            busNo = tk.Label(rowFrame, text="{} {}".format(" "*2, bus), font=("Helvetica", departureFontSize), bg=bgColor)
            busDest = tk.Label(rowFrame, text=destination, font=("Helvetica", destinationFontSize), bg=bgColor)
            minsLeft = tk.Label(rowFrame, text="{} {}".format(int(minutes), " "*4) if int(minutes) != 0 else "Now", font=("Helvetica", departureFontSize), bg=bgColor)
